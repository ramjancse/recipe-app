const RECIPES = [
    {
      ...
      timers: [0, 0, 0, 420],
      imageURL:
        "https://media.istockphoto.com/photos/slow-cooker-roast-pork-with-vegetables-picture-id1306132293?k=20&m=1306132293&s=612x612&w=0&h=MozppRtWxWvLwq7zx_2TTtDLMaX7_tzJ0uyckjzGh2Y=",
    ...
    },
    {
      ...
      timers: [0, 0, 20, 20, 0],
      imageURL:
        "https://cdn.pixabay.com/photo/2016/02/19/11/30/shrimp-1209744_960_720.jpg",
    },
    {
      ...
      imageURL:
        "https://cdn.pixabay.com/photo/2021/07/19/16/04/pizza-6478478_960_720.jpg",
    },
    {
    ...
    },
    {
      ...
      imageURL:
        "https://cdn.pixabay.com/photo/2017/06/16/07/00/porridge-2408030_960_720.jpg",
      originalURL: "#",
    },
  
    {
      ...
      imageURL:
        "https://cdn.pixabay.com/photo/2016/02/13/16/54/food-1198204_960_720.jpg",
      originalURL:
...
import { FlatList, Image, SafeAreaView, ScrollView, StatusBar, StyleSheet, Text, TextInput, View } from 'react-native';
    ...
    const {name, imageURL, ingredients, steps } = item
      ...
      return (
        <View style={styles.card}>
          ...
          <Text style={{fontSize: 20, fontWeight: 'bold', paddingHorizontal: 10,}}> {name} </Text>
         
         <View style={{paddingHorizontal : 10,}}>
           {ingredients.map( (ingredient, index) => 
            <View> 
                <Text> { index + 1 } - {ingredient.quantity} {ingredient.name} </Text>
            </View>)
           }
         </View>
  
         <View style={{paddingHorizontal :10,}}>
           <Text style={{fontSize: 20, fontWeight: 'bold', marginVertical: 10,}}> Steap by step guideline </Text>
  ...
  const styles = StyleSheet.create({
    ...
    card : {
      ...
      borderColor:'#808080', // if you need 
        borderWidth:1,
        overflow: 'hidden',
        shadowColor: '#ff0000',
        shadowRadius: 2,
